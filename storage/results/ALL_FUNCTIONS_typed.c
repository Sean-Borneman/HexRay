...
extern const char DAT_001021ee[];
...
void _start(long param_1, char **param_2)
{
    ...
    (*(int (*)(int (*)(void), char **, char **, void *, void *, long, char *))PTR___libc_start_main_00103fd8)(main, param_2, &auStack_8, 0, 0, param_1, auStack_8);
    do {
...
void _ITM_deregisterTMCloneTable(void)
{
    ...
    while(1); // halt_baddata equivalent
}
