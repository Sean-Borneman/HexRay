...
def export_with_pyghidra():
    ...
    ghidra_install_dir = r"Hack-CMU-2025\Ghidra_full_open_source_install\ghidra_11.4.2_PUBLIC"
    ...
    project_name = rep_file.stem  # Get filename without .rep extension

    ghidra_install_dir = r"Hack-CMU-2025\Ghidra_full_open_source_install\ghidra_11.4.2_PUBLIC"
    project_dir = Path("./ghidra_projects").resolve()
    project_name = "chall_analysis"
    output_dir = Path("./decompiled_txt")
    output_dir.mkdir(exist_ok=True)
